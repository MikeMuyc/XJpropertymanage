    ...
    <div class="costTable">
        ...
        <div style="padding: 20px 0 ;display: flex">
            <div class="tabSelection">
                <div class="tabItem" :class="{active:costState===0}" @click="stateChange(0)">汇总表</div>
                <div class="tabItem" :class="{active:costState===1}" @click="stateChange(1)">统计图</div>
            </div>
        </div>
        <div class="searchline">
            ...
            <div class="right">
                <!--<div class="pmbtn primary margin" :class="{disable:titleFlag}" @click="titleFlag = !titleFlag">-->
                    <!--<i class="iconfont iconbianji"></i>修改标题-->
                <!--</div>-->
                <div class="pmbtn margin">
                ...
                <div class="pmbtn margin">
                    <i class="iconfont icontuisong"></i>推送至财务
                </div>
            </div>
        </div>

        <transition name="leftSlide">
            <div class="borderbox" v-show="costState === 0">
                <div class="boxtitle">
        ...
        <transition name="rightSlide">
            <div class="borderbox" v-show="costState === 1">
                <div class="boxtitle">
                    <input v-model="echartTitle"/>
                </div>
                <div class="tip" style="padding: 0 15%">
                    <div class="margin">收费日期：2019-06-01 ~ 2020-06-01</div>
                    <div class="margin">查询日期：2020-06-01</div>
                </div>
                <v-chart
        ...
        lessonType: any =  {
            ...
            series: [
                ...
                },
                {
                    ...
                    barWidth: 20,
                    data: [1400, 1200, 1300, 1240, 220, 1500, 1620,],
                }
...
<style lang="scss" scoped>
    ...
    .costTable {
        ...
        .borderbox{
            ...
            padding: 20px;
            width: 100%;
            height: calc(100% - 60px - 72px - 56px - 15px);
            .boxtitle{
                text-align: center;
                margin-bottom: 20px;
                >input{
